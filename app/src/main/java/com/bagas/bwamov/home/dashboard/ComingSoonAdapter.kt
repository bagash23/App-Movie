...
class ComingSoonAdapter(private var data: List<Film>, private val listner: (Film) -> Unit) : RecyclerView.Adapter<ComingSoonAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ComingSoonAdapter.ViewHolder {
        ...
        val infaltedView = layoutInflater.inflate(R.layout.row_item_coming_soon, parent, false)
